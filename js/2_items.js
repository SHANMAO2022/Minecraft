        // ==========================================
        const ITEM_NAMES = {
            grass: "草方块", dirt: "泥土", sand: "沙子", leaves: "树叶", tall_grass: "高草丛", log: "橡木原木", planks: "橡木木板", glass: "玻璃", stone: "石头", coal_ore: "煤矿石", iron_ore: "铁矿石", gold_ore: "金矿石", diamond_ore: "钻石矿石", emerald_ore: "绿宝石矿石", composter: "堆肥桶", bedrock: "基岩", water: "水", lava: "熔岩", crafting_table: "工作台", furnace: "熔炉", end_rod: "末地烛", obsidian: "黑曜石", nether_portal: "下界传送门", netherrack: "下界岩", magma: "岩浆块", nether_bricks: "下界砖块", spawner: "刷怪笼", end_stone: "末地石", end_portal_frame_empty: "末地传送门框架", end_portal_frame_filled: "激活的传送门框架", end_portal: "末地传送门", stone_brick: "石砖", return_portal: "返回传送门", 
            snow: "雪", ice: "冰", cactus: "仙人掌", lily_pad: "睡莲",
            cobblestone: "原石", oak_slab: "橡木半砖", stone_slab: "石半砖", cobblestone_slab: "圆石半砖", oak_stairs: "橡木楼梯", stone_stairs: "石楼梯", cobblestone_stairs: "圆石楼梯", oak_fence: "橡木栅栏", oak_fence_gate: "橡木栅栏门", oak_fence_gate_open: "开启的橡木栅栏门",
            oak_stairs_inner_left: "橡木楼梯内左转角", oak_stairs_inner_right: "橡木楼梯内右转角",
            stone_stairs_inner_left: "石楼梯内左转角", stone_stairs_inner_right: "石楼梯内右转角",
            cobblestone_stairs_inner_left: "圆石楼梯内左转角", cobblestone_stairs_inner_right: "圆石楼梯内右转角",
            door_top: "木门顶半部", door_bottom: "木门底半部", door_top_open: "开启的木门顶半部", door_bottom_open: "开启的木门底半部",
            ...
            iron_ingot: "铁锭", gold_ingot: "金锭", coal: "煤炭", diamond: "钻石", emerald: "绿宝石",
            ...
            pig_spawn_egg: "猪刷怪蛋", cow_spawn_egg: "牛刷怪蛋", zombie_spawn_egg: "僵尸刷怪蛋", spider_spawn_egg: "蜘蛛刷怪蛋", blaze_spawn_egg: "烈焰人刷怪蛋", enderman_spawn_egg: "末影人刷怪蛋", villager_spawn_egg: "村民刷怪蛋", dragon_spawn_egg: "末影龙刷怪蛋"
        };
        ...
        const ITEMS = {
            ...
            cobblestone: { type: 'block', hardness: 5.0, tool: 'pickaxe', tier: 1 },
            oak_stairs: { type: 'block', hardness: 2.0, tool: 'none', tier: 0 }, stone_stairs: { type: 'block', hardness: 3.0, tool: 'pickaxe', tier: 1 }, cobblestone_stairs: { type: 'block', hardness: 3.0, tool: 'pickaxe', tier: 1 },
            oak_stairs_inner_left: { type: 'block', hardness: 2.0, tool: 'none', tier: 0 }, oak_stairs_inner_right: { type: 'block', hardness: 2.0, tool: 'none', tier: 0 },
            stone_stairs_inner_left: { type: 'block', hardness: 3.0, tool: 'pickaxe', tier: 1 }, stone_stairs_inner_right: { type: 'block', hardness: 3.0, tool: 'pickaxe', tier: 1 },
            cobblestone_stairs_inner_left: { type: 'block', hardness: 3.0, tool: 'pickaxe', tier: 1 }, cobblestone_stairs_inner_right: { type: 'block', hardness: 3.0, tool: 'pickaxe', tier: 1 },
            oak_slab: { type: 'block', hardness: 2.0, tool: 'none', tier: 0 }, stone_slab: { type: 'block', hardness: 3.0, tool: 'pickaxe', tier: 1 }, cobblestone_slab: { type: 'block', hardness: 3.0, tool: 'pickaxe', tier: 1 },
            oak_fence: { type: 'block', hardness: 2.0, tool: 'none', tier: 0 }, oak_fence_gate: { type: 'block', hardness: 2.0, tool: 'none', tier: 0 }, oak_fence_gate_open: { type: 'block', hardness: 2.0, tool: 'none', tier: 0 },
            ...
            emerald_ore: { type: 'block', hardness: 12.0, tool: 'pickaxe', tier: 3 }, composter: { type: 'block', hardness: 0.6, tool: 'none', tier: 0 },
            ...
            wooden_sword: { type: 'tool', toolType: 'sword', tier: 1, power: 5, damage: 4 }, stone_sword: { type: 'tool', toolType: 'sword', tier: 2, power: 10, damage: 5 }, iron_sword: { type: 'tool', toolType: 'sword', tier: 3, power: 18, damage: 6 }, golden_sword: { type: 'tool', toolType: 'sword', tier: 3, power: 25, damage: 4 }, diamond_sword: { type: 'tool', toolType: 'sword', tier: 4, power: 7, damage: 7 },
            ...
            iron_ingot: { type: 'item' }, gold_ingot: { type: 'item' }, coal: { type: 'item', fuelValue: 80 }, diamond: { type: 'item' }, emerald: { type: 'item' },
            ...
            door: { type: 'item' },
            pig_spawn_egg: { type: 'item' }, cow_spawn_egg: { type: 'item' }, zombie_spawn_egg: { type: 'item' }, spider_spawn_egg: { type: 'item' },
            blaze_spawn_egg: { type: 'item' }, enderman_spawn_egg: { type: 'item' }, villager_spawn_egg: { type: 'item' }, dragon_spawn_egg: { type: 'item' }
        };

        const blockTypes = ['grass', 'dirt', 'stone', 'bedrock', 'log', 'leaves', 'tall_grass', 'sand', 'planks', 'glass', 'coal_ore', 'iron_ore', 'gold_ore', 'diamond_ore', 'emerald_ore', 'composter', 'obsidian', 'nether_portal', 'netherrack', 'magma', 'nether_bricks', 'spawner', 'end_stone', 'end_portal_frame_empty', 'end_portal_frame_filled', 'end_portal', 'stone_brick', 'return_portal', 'water', 'lava', 'crafting_table', 'furnace', 'end_rod', 'torch', 'bed', 'bed_head', 'bed_foot', 'chest', 'door_top', 'door_bottom', 'door_top_open', 'door_bottom_open', 'snow', 'ice', 'cactus', 'lily_pad', 'cobblestone', 'oak_stairs', 'stone_stairs', 'cobblestone_stairs', 'oak_slab', 'stone_slab', 'cobblestone_slab', 'oak_fence', 'oak_fence_gate', 'oak_fence_gate_open', 'oak_stairs_inner_left', 'oak_stairs_inner_right', 'stone_stairs_inner_left', 'stone_stairs_inner_right', 'cobblestone_stairs_inner_left', 'cobblestone_stairs_inner_right'];
        window.getBaseType = function(type) {
            if (!type) return type;
            const facingBase = type.replace(/_(north|south|east|west)$/, '');
            if (facingBase !== type && (blockTypes.includes(facingBase) || ITEMS[facingBase])) return facingBase;
            return type;
        };
        window.getTypeFacing = function(type) {
            if (!type) return null;
            const m = String(type).match(/_(north|south|east|west)$/);
            return m ? m[1] : null;
        };
        window.getFacingFromDelta = function(dx, dz) {
            if (Math.abs(dx) >= Math.abs(dz)) return dx >= 0 ? 'east' : 'west';
            return dz >= 0 ? 'south' : 'north';
        };
        window.withFacing = function(type, facing) {
            if (!type) return type;
            if (!facing || !['north', 'south', 'east', 'west'].includes(facing)) return type;
            return `${type}_${facing}`;
        };
        window.getStairRootType = function(type) {
            const base = window.getBaseType ? window.getBaseType(type) : type;
            if (!base) return base;
            return String(base).replace(/_inner_(left|right)$/, '');
        };
        window.isStairType = function(type) {
            const root = window.getStairRootType ? window.getStairRootType(type) : type;
            return !!(root && root.endsWith('_stairs') && ITEMS[root]);
        };
        window.getStairVariantType = function(type, variant) {
            const root = window.getStairRootType ? window.getStairRootType(type) : type;
            if (!root || !root.endsWith('_stairs')) return type;
            if (variant === 'inner_left') return `${root}_inner_left`;
            if (variant === 'inner_right') return `${root}_inner_right`;
            return root;
        };
        const itemTypes = ['wooden_pickaxe', 'stone_pickaxe', 'iron_pickaxe', 'gold_pickaxe', 'diamond_pickaxe', 'wooden_sword', 'stone_sword', 'iron_sword', 'golden_sword', 'diamond_sword', 'wooden_axe', 'stone_axe', 'iron_axe', 'golden_axe', 'diamond_axe', 'leather_helmet', 'leather_chestplate', 'leather_leggings', 'leather_boots', 'iron_helmet', 'iron_chestplate', 'iron_leggings', 'iron_boots', 'golden_helmet', 'golden_chestplate', 'golden_leggings', 'golden_boots', 'diamond_helmet', 'diamond_chestplate', 'diamond_leggings', 'diamond_boots', 'iron_ingot', 'gold_ingot', 'coal', 'diamond', 'emerald', 'raw_porkchop', 'cooked_porkchop', 'raw_beef', 'cooked_beef', 'leather', 'rotten_flesh', 'flint_and_steel', 'ender_pearl', 'blaze_powder', 'ender_eye', 'blaze_rod', 'bow', 'arrow', 'stick', 'string', 'flint', 'door', 'pig_spawn_egg', 'cow_spawn_egg', 'zombie_spawn_egg', 'spider_spawn_egg', 'blaze_spawn_egg', 'enderman_spawn_egg', 'villager_spawn_egg', 'dragon_spawn_egg'];
        const allItemTypes = [...blockTypes, ...itemTypes];
        const update100ContentTypes = new Set(['emerald_ore', 'composter', 'emerald', 'villager_spawn_egg']);
        window.update100ContentTypes = update100ContentTypes;
        window.isUpdate100ContentType = function(type) {
            if (!type) return false;
            const base = window.getBaseType ? window.getBaseType(type) : type;
            return !!(window.update100ContentTypes && window.update100ContentTypes.has(base));
        };
        window.canUseItemType = function(type) {
            return true;
        };
        const hiddenBlockTypes = new Set(['bed_head', 'bed_foot', 'door_top', 'door_bottom', 'door_top_open', 'door_bottom_open', 'oak_fence_gate_open']);
        window.hiddenBlockTypes = hiddenBlockTypes;
        const inventoryItemTypes = allItemTypes.filter(t => !hiddenBlockTypes.has(t));

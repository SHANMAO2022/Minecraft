        ...
        const ITEM_NAMES = {
            ...
            raw_porkchop: "生猪排", cooked_porkchop: "熟猪排", rotten_flesh: "腐肉", flint_and_steel: "打火石", ender_pearl: "末影珍珠", blaze_powder: "烈焰粉", ender_eye: "末影之眼", blaze_rod: "烈焰棒", bow: "弓", arrow: "箭", stick: "木棍", string: "线", flint: "燧石", torch: "火把", bed: "床", bed_head: "床头", bed_foot: "床尾"
        };
        ...
        const ITEMS = {
            ...
            raw_porkchop: { type: 'food', hungerRestore: 6 }, cooked_porkchop: { type: 'food', hungerRestore: 12 }, rotten_flesh: { type: 'food', hungerRestore: 4 },
        ...
        const itemTypes = ['wooden_pickaxe', 'stone_pickaxe', 'iron_pickaxe', 'gold_pickaxe', 'diamond_pickaxe', 'iron_ingot', 'gold_ingot', 'coal', 'diamond', 'raw_porkchop', 'cooked_porkchop', 'rotten_flesh', 'flint_and_steel', 'ender_pearl', 'blaze_powder', 'ender_eye', 'blaze_rod', 'bow', 'arrow', 'stick', 'string', 'flint'];
